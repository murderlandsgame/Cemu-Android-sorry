...
public class OverlaySettingsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ToggleRecyclerViewItem overlayFps = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem drawCallsToggle = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem cpuUsageToggle = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem ramUsageToggle = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem debugToggle = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem controllerProfiles = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem shaderCompiler = new ToggleRecyclerViewItem(
        ...
        ToggleRecyclerViewItem friendList = new ToggleRecyclerViewItem(
